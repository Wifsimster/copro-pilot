...
type Tab = 'dashboard' | 'profil' | 'documents' | 'compte' | 'charges' | 'appels' | 'fonds' | 'conseil'
    ...
    <div className="space-y-6">
      ...
      {solde > 0 && (
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm text-amber-700 dark:border-amber-800 dark:bg-amber-900/20 dark:text-amber-400">
          Vous avez un solde debiteur de {formatEur(solde)}. Merci de
      ...
      {dashboard.upcomingAGs.length > 0 && (
        <Section title="Prochaines assemblees generales" icon={Calendar}>
      ...
      <div className="rounded-lg border border-border bg-card p-4">
        <h3 className="mb-3 text-sm font-semibold">Acces rapide</h3>
