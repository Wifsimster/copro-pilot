...
import { Handshake, Plus, Trash2, Pencil, ChevronDown, FileSignature, Building2, AlertTriangle } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      {!selectedCoproId ? (
        <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 p-12 dark:border-zinc-600">
          ...
          <p className="mt-2 text-gray-500 dark:text-zinc-400">Choisissez une copropriete pour voir ses contrats.</p>
        </div>
      ) : (
        <>
          {/* Tabs */}
