      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              Gerez vos coproprietes sans prise de tete
            </motion.h1>
            ...
            >
              Le logiciel de syndic le plus simple pour les benevoles et petits
              cabinets. Operationnel en 5 minutes, sans installation.
            </motion.p>
            ...
            >
              Sans engagement · Sans carte bancaire · Donnees hebergees en
              France
            </motion.p>
          </div>
