...
router.get('/dashboard', requireAuth(), async (req, res) => {
    try {
        ...
        const [coproprietes, coproprietaires, incidentsOuverts, prochainAG] = await Promise.all([
        ...
        const recentIncidents = await db('incidents')
            .select('incidents.id', 'incidents.titre', 'incidents.urgence', 'incidents.statut', 'incidents.date_signalement', 'coproprietes.nom as copropriete_nom')
